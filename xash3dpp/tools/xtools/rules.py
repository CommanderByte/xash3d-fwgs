...
RULES: list[Rule] = [
    Rule(
        check="entvars-confinement",
        severity="blocker",
        # Raw entvars access is `ed->v.<field>`; EntityView is the sanctioned
        # accessor everywhere else (Q-20).
        pattern=r"->\s*v\s*\.",
        scopes=("src",),
        ...
        source_ref="decisions-architecture Q-20 (EDICT_STORE); "
                   "server-boundary Extension axes",
