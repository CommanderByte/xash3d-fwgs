...
// @thread-safety: sim-thread-confined (server/client tick — Main today; NOT NetIO, see networking-threading.md "flip nuance") — table state caller-serialised; DeltaTables::stats() Tier-1 atomics are any-thread read-safe
