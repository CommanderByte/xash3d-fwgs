#pragma once
// xash3dpp — IMasterListClient: master-server heartbeat / query satellite
// Boundary spec: docs/boundaries/networking-boundary.md §OQ-6
//
// Lives inside xash3dpp_networking per the Q-11 satellite-placement test
// (score 1 — same target).  The server layer configures the master-list
// client; networking owns the actual UDP I/O.
